...
class AppStrings {
  static const Map<AppLanguage, Map<String, String>> _data = {
    AppLanguage.english: {
      ...
      // Settings
      'settings': 'Settings',
      'videoRewardSection': 'Video Reward',
      'videoEnabled': 'Show video after level completion',
      'videoTimeLimit': 'Video time limit',
      'youtubeSection': 'YouTube Source',
      'youtubeVideoId': 'Video ID',
      'youtubeVideoIdHint': 'From youtube.com/watch?v=XXXXXX',
      'youtubePlaylistId': 'Playlist ID',
      'youtubePlaylistIdHint': 'If set, a random video from the playlist is used',
      'playlistPriority': 'Priority: Playlist ID → Video ID (if playlist is empty)',
      'save': 'Save',
      'timeLimitUnlimited': 'Unlimited',
      // Animals
      'cat': 'Cat',
      'dog': 'Dog',
      'cow': 'Cow',
    ...
    AppLanguage.ukrainian: {
      ...
      'videoRewardSection': 'Відео нагорода',
      'videoEnabled': 'Показувати відео після рівня',
      'videoTimeLimit': 'Тривалість відео',
      'youtubeSection': 'Джерело YouTube',
      'youtubeVideoId': 'Video ID',
      'youtubeVideoIdHint': 'З youtube.com/watch?v=XXXXXX',
      'youtubePlaylistId': 'Playlist ID',
      'youtubePlaylistIdHint': 'Якщо вказано — випадкове відео з плейліста',
      'playlistPriority': 'Пріоритет: Playlist ID → Video ID (якщо плейліст порожній)',
      'save': 'Зберегти',
      'timeLimitUnlimited': 'Без обмеження',
      // Animals
      'cat': 'Кіт',
      'dog': 'Собака',
      'cow': 'Корова',
